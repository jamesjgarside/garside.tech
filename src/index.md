...
No tracking, no analytics, no bloat.

Deployed on Cloudflare Pages.

Inspired by [IndieWeb](https://indieweb.org/) philosophy of owning content and controlling the platform.

Fast, simple, human-scale web publishing. RSS feeds for every topic. 

Read in your favorite reader or subscribe via [newsletter](/newsletter).
